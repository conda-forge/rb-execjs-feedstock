...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-execjs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7701&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-execjs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-execjs` can be installed with:

```
conda install rb-execjs
```

It is possible to list all of the versions of `rb-execjs` available on your platform with:
